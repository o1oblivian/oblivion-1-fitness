        ...
        <div className="flex justify-between items-center border-b border-[rgba(0,0,0,0.08)] dark:border-slate-800 pb-2">
          <div>
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-mono font-bold px-1.5 py-0.5 rounded-full bg-[#C4121A]/10 text-[#C4121A] dark:text-[#D91F28] border border-[#C4121A]/30 uppercase tracking-wider flex items-center gap-1">
                <Flame className="w-3 h-3 text-[#C4121A] dark:text-[#D91F28]" /> Energy Matrix
              </span>
              <span className="text-[10px] font-mono font-bold text-[#3FB98E] bg-[#3FB98E]/10 px-1.5 py-0.5 rounded-md border border-[#3FB98E]/30">
          ...
          <button
            ...
            className={`flex-1 py-1.5 rounded-lg font-bold transition-all cursor-pointer text-center flex items-center justify-center gap-1 ${
              activeTab === 'expenditure'
                ? 'bg-[#3FB98E] text-white shadow-2xs'
          ...
          <div className="space-y-2 text-xs font-mono">
            ...
            <div className="grid grid-cols-3 gap-2 text-center">
              <div className="bg-[#F2F2F7] dark:bg-white/5 p-2 rounded-xl border border-[rgba(0,0,0,0.08)] dark:border-white/10 flex flex-col justify-center">
                ...
                <span className="text-[8.5px] text-[#3FB98E] font-bold">Goal: {target} kcal</span>
              </div>

              <div className="bg-[#F2F2F7] dark:bg-white/5 p-2 rounded-xl border border-[rgba(0,0,0,0.08)] dark:border-white/10 flex flex-col justify-center">
                <span className="text-[9px] text-[#C4121A] dark:text-[#D91F28] font-bold uppercase">TRAINING BURN</span>
                <span className="text-sm font-black text-[#C4121A] dark:text-[#D91F28] mt-0.5">{burnVal} kcal</span>
                <span className="text-[8.5px] text-[#5A5F5D]">Active Session</span>
              </div>

              <div className="bg-[#F2F2F7] dark:bg-white/5 p-2 rounded-xl border border-[rgba(0,0,0,0.08)] dark:border-white/10 flex flex-col justify-center">
                <span className="text-[9px] text-[#3FB98E] font-bold uppercase">NET BALANCE</span>
                <span className="text-sm font-black text-[#3FB98E] mt-0.5">{netSurplusDeficit > 0 ? `+${netSurplusDeficit}` : netSurplusDeficit}</span>
            ...
            <div className="bg-white dark:bg-black/40 p-3 rounded-xl border border-[rgba(0,0,0,0.08)] dark:border-white/10 space-y-2">
              ...
              <div className="space-y-0.5">
                <div className="flex justify-between items-center text-[10px]">
                  <span className="font-bold text-[#C4121A] dark:text-[#D91F28]">Protein (4 kcal/g)</span>
                ...
                <div className="w-full bg-[#E5E5EA] dark:bg-white/10 h-2 rounded-full overflow-hidden">
                  <div className="bg-[#C4121A] dark:bg-[#D91F28] h-full w-[92%] transition-all duration-500" />
                </div>
              </div>
              ...
              <div className="space-y-0.5">
                <div className="flex justify-between items-center text-[10px]">
                  <span className="font-bold text-[#3FB98E]">Fats (9 kcal/g)</span>
                  <span className="font-black text-[#000000] dark:text-white">72g / 75g (96%)</span>
                </div>
                <div className="w-full bg-[#E5E5EA] dark:bg-white/10 h-2 rounded-full overflow-hidden">
                  <div className="bg-[#3FB98E] h-full w-[96%] transition-all duration-500" />
                </div>
              </div>
            </div>
            ...
            <button
              ...
              className="w-full py-2 rounded-xl bg-[#C4121A] hover:bg-[#D91F28] text-white font-bold text-xs transition-all cursor-pointer shadow-2xs flex items-center justify-center gap-2"
            >
          ...
          <div className="space-y-2 font-mono text-xs">
            <div className="flex justify-between items-center px-0.5">
              ...
              <button
                ...
                className="text-[9.5px] text-[#C4121A] dark:text-[#D91F28] hover:underline font-bold flex items-center gap-1 cursor-pointer"
              >
            ...
            <div className="space-y-1.5 max-h-60 overflow-y-auto pr-0.5">
              {mealTimingLogs.map((meal) => (
                <div
                  key={meal.id}
                  className="bg-white dark:bg-black/40 p-2 rounded-xl border border-[rgba(0,0,0,0.08)] dark:border-white/10 space-y-1 hover:border-[#C4121A] transition-all"
                >
                  <div className="flex justify-between items-center">
                    <div className="flex items-center gap-2">
                      <span className="font-bold text-[#000000] dark:text-white text-[11px]">{meal.mealName}</span>
                      <span className="text-[8.5px] font-bold px-1.5 py-0.2 rounded bg-[#C4121A]/10 text-[#C4121A] dark:text-[#D91F28] border border-[#C4121A]/20">
                        {meal.badge}
                      </span>
                    </div>
                  ...
                  <div className="flex justify-between items-center text-[9.5px] pt-1 border-t border-[rgba(0,0,0,0.08)] dark:border-white/10">
                    <span className="text-[#3FB98E] font-bold">{meal.macros}</span>
        ...
        {activeTab === 'expenditure' && (
          <div className="space-y-2 font-mono text-xs">
            <div className="bg-white dark:bg-black/40 p-2 rounded-xl border border-[rgba(0,0,0,0.08)] dark:border-white/10 space-y-1.5">
              ...
              <div className="flex justify-between items-center pb-1 border-b border-[rgba(0,0,0,0.08)] dark:border-white/10">
                <span className="font-bold text-[#C4121A] dark:text-[#D91F28] text-[11px]">Active Training Burn (Avg)</span>
                <span className="font-black text-[#C4121A] dark:text-[#D91F28] text-[11px]">+{burnVal} kcal</span>
              </div>
              <div className="flex justify-between items-center">
                <span className="font-bold text-[#3FB98E] text-[11px]">NEAT Non-Exercise Activity</span>
                <span className="font-black text-[#3FB98E] text-[11px]">+320 kcal</span>
              </div>
            </div>
                ...
                {burnHistory.map((item, i) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-black text-[#C4121A] dark:text-[#D91F28]">Out: {item.total}</span>
                    </div>
                  </div>
                ))}
              </div>
