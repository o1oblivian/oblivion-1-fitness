        ...
        <div className="relative">
          ...
          <div className="h-32 bg-[#1A1E1D] relative overflow-hidden">
            {program.cover_image_url ? (
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-[#1A1E1D] via-[#2A2F2D] to-[#C4121A]/30" />
            )}
        ...
        <div className="flex-1 overflow-y-auto p-3.5 space-y-4 pb-28">
          {purchaseComplete ? (
            ...
            <div className="text-center py-6">
              ...
              <button
                onClick={handleClose}
                className="w-full mt-4 py-3 bg-[#C4121A] text-white font-bold text-xs rounded-xl hover:bg-[#9B0E14] active:scale-95 transition-all cursor-pointer"
              >
                Start Training
              </button>
            </div>
            ...
            <>
              ...
              <div className="grid grid-cols-3 gap-2">
                <div className="bg-[#F2F2F7] rounded-xl p-2 border border-[rgba(0,0,0,0.08)] text-center">
                  <Clock className="w-3.5 h-3.5 text-[#C4121A] mx-auto mb-1" />
                ...
                <div className="bg-[#F2F2F7] rounded-xl p-2 border border-[rgba(0,0,0,0.08)] text-center">
                  <TrendingUp className="w-3.5 h-3.5 text-[#3FB98E] mx-auto mb-1" />
              ...
              {!isFree && (
                <div className="bg-[#F2F2F7] rounded-xl p-4 border border-[rgba(0,0,0,0.08)] space-y-2">
                  ...
                  <div className="flex justify-between text-xs">
                    ...
                    <span className="text-[#C4121A] font-mono">-{formatPrice(commission.fee)}</span>
                  </div>
                  ...
                  <>
                    <div className="space-y-1.5">
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 rounded-lg border border-[rgba(0,0,0,0.08)] bg-white text-xs font-mono text-[#000000] focus:outline-none focus:ring-2 focus:ring-[#C4121A]/30"
                      />
                    </div>
              ...
              <div className="flex items-center gap-2 text-[10px] text-gray-500 font-mono">
                <Shield className="w-3.5 h-3.5 text-[#3FB98E]" />
              ...
              <button
                ...
                className="w-full py-3.5 bg-[#C4121A] text-white font-bold text-sm rounded-xl hover:bg-[#9B0E14] active:scale-95 transition-all cursor-pointer disabled:opacity-50 flex items-center justify-center gap-2 shadow-sm"
              >
                {isProcessing ? (
                  <>
