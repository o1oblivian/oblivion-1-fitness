...
export const GoogleLogo: React.FC<{ className?: string }> = ({ className = "w-4 h-4 shrink-0" }) => (
...
export const GmailLogo: React.FC = () => (
  <svg className="w-4 h-4 shrink-0" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M22.5 5.75v12.5c0 1.24-1.01 2.25-2.25 2.25h-3.75V11.5L12 16.25 7.5 11.5v9H3.75C2.51 20.5 1.5 19.49 1.5 18.25V5.75c0-1.8 1.95-2.92 3.5-1.95L12 9.5l7-5.7c1.55-.97 3.5.15 3.5 1.95z" fill="#C4121A" />
    <path d="M16.5 11.5v9h3.75c1.24 0 2.25-1.01 2.25-2.25V5.75L16.5 11.5z" fill="#3FB98E" />
    <path d="M1.5 5.75v12.5c0 1.24 1.01 2.25 2.25 2.25H7.5v-9L1.5 5.75z" fill="#2D7FF9" />
    <path d="M1.5 5.75c0-1.8 1.95-2.92 3.5-1.95L7.5 5.8v5.7L1.5 5.75z" fill="#9B0E14" />
    <path d="M22.5 5.75c0-1.8-1.95-2.92-3.5-1.95L16.5 5.8v5.7l6-5.75z" fill="#E8B04A" />
  </svg>
);

export const AppleLogo: React.FC<{ className?: string }> = ({ className = "w-4 h-4 shrink-0" }) => (
                ...
                <form onSubmit={handleSignIn} className="space-y-4">
                  ...
                  <div className="pt-2 space-y-3">
                    ...
                    <div className="space-y-2 pt-0.5">
                      {/* Official Apple HIG Sign in Button */}
                      <button
                        type="button"
                        onClick={() => handleSocialAuth('apple')}
                        disabled={loading}
                        className="w-full h-11 bg-black hover:bg-zinc-900 active:scale-[0.99] text-white rounded-xl flex items-center justify-center gap-2.5 px-4 transition-all cursor-pointer shadow-xs"
                      >
                        <AppleLogo className="w-4 h-4 fill-white shrink-0" />
                      ...
                      <button
                        ...
                        disabled={loading}
                        className="w-full h-11 bg-white hover:bg-zinc-50 active:scale-[0.99] border border-zinc-300 hover:border-zinc-400 text-zinc-800 rounded-xl flex items-center justify-center gap-2.5 px-4 transition-all cursor-pointer shadow-2xs"
                      >
              ...
              >
                ...
                <form onSubmit={handleRegister} className="space-y-3.5">
                  ...
                  <div className="pt-2 space-y-2.5">
                    ...
                    <div className="space-y-2 pt-0.5">
                      {/* Official Apple HIG Sign Up Button */}
                      <button
                        type="button"
                        onClick={() => handleSocialAuth('apple')}
                        disabled={loading}
