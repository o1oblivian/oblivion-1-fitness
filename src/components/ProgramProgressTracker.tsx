  ...
  return (
    <div className="rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-[#18181B] p-4 sm:p-5 space-y-4 shadow-xl text-zinc-900 dark:text-white animate-fadeIn">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-zinc-200 dark:border-zinc-800">
        ...
        <span className="text-[10px] font-mono font-bold text-[#C4121A] bg-red-50 dark:bg-red-950/40 px-2 py-0.5 rounded border border-red-200 dark:border-red-900">
          COACH HUB
        </span>
      </div>
        ...
        <div className="space-y-2.5">
          <div className="flex items-center justify-between">
            <span className="text-[10px] font-mono text-zinc-500 dark:text-zinc-400 uppercase tracking-wider flex items-center gap-1.5">
              <Sparkles className="w-3 h-3 text-[#C4121A]" /> Dispatched Workouts ({dispatchedWorkouts.length})
            </span>
          </div>
      ...
      {programs.length > 0 && (
        <div className="space-y-2.5">
          <div className="text-[10px] font-mono text-zinc-500 dark:text-zinc-400 uppercase tracking-wider flex items-center gap-1.5">
            <Trophy className="w-3 h-3 text-[#C4121A]" /> Enrolled Programs
          </div>
              ...
              >
                ...
                >
                  <div className="w-8 h-8 rounded-xl bg-zinc-200 dark:bg-zinc-800 flex items-center justify-center shrink-0 border border-zinc-300 dark:border-zinc-700">
                    <Trophy className="w-4 h-4 text-[#C4121A]" />
                  </div>
                    ...
                    <div className="w-8 h-8 relative">
                      <svg className="w-full h-full -rotate-90" viewBox="0 0 36 36">
                        ...
                        <circle
                          ...
                          strokeLinecap="round"
                          className="text-[#C4121A]"
                        />
                      </svg>
                      <span className="absolute inset-0 flex items-center justify-center text-[7px] font-black text-[#C4121A]">
      ...
      {!hasContent && (
        <div className="p-4 bg-zinc-50 dark:bg-zinc-900/40 border border-zinc-200 dark:border-zinc-800 rounded-2xl text-center space-y-3">
          <div className="w-10 h-10 rounded-2xl bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 flex items-center justify-center mx-auto text-zinc-500 dark:text-zinc-400">
            <UserCheck className="w-5 h-5 text-[#C4121A]" />
          </div>
          <div>
  ...
  return (
    ...
    >
      ...
      <div className={`w-7 h-7 rounded-lg flex items-center justify-center shrink-0 ${
        ...
        {isCompleted ? (
          <CheckCircle2 className="w-3.5 h-3.5 text-[#C4121A]" />
        ) : isActive ? (
      ...
      {isActive && !isCompleted && (
        <div className="flex gap-1.5 shrink-0">
          ...
          <button
            ...
            className="flex items-center gap-1 px-2.5 py-1.5 rounded-lg bg-red-500/10 text-[#C4121A] text-[9px] font-bold active:scale-95 transition-all cursor-pointer border border-red-400/20 disabled:opacity-50"
          >
            {isCompleting ? (
              <div className="w-3 h-3 border-2 border-[#C4121A] border-t-transparent rounded-full animate-spin" />
            ) : (
