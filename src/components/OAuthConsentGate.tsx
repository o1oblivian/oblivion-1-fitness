      ...
      >
          ...
          {CONSENT_CHECKS.map((check) => (
            <label key={check.id} className="flex items-start gap-3 cursor-pointer select-none group">
              <div className="relative mt-0.5 shrink-0">
                ...
                />
                <div className="w-5 h-5 rounded-md border border-zinc-300 dark:border-zinc-700 peer-checked:bg-[#C4121A] peer-checked:border-[#C4121A] transition-all flex items-center justify-center">
                  {consents[check.id] && (
        ...
        <div className="flex flex-col items-center gap-4 pt-2">
          ...
          <button
            ...
            className={`w-full py-3 rounded-full bg-[#C4121A] text-white hover:bg-[#9B0E14] text-xs font-bold transition-all cursor-pointer flex items-center justify-center gap-2 shadow-xs active:scale-98 ${
