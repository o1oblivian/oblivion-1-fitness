            ...
            <AreaChart data={chartTrendData} margin={{ top: 2, right: 4, left: -26, bottom: 0 }}>
              <defs>
                <linearGradient id="suppAdhGradient" x1="0" y1="0" x2="0" y2="1">
                  <stop offset="5%" stopColor="#3FB98E" stopOpacity={0.4} />
                  <stop offset="95%" stopColor="#3FB98E" stopOpacity={0.0} />
                </linearGradient>
              ...
              />
              <Area type="monotone" dataKey="Compliance" stroke="#3FB98E" strokeWidth={1.8} fillOpacity={1} fill="url(#suppAdhGradient)" />
