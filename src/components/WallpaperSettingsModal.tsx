      ...
      >
        ...
        <div className="flex-1 overflow-y-auto px-5 py-4 space-y-4">
                ...
                return (
                  <button
                    ...
                    className={`p-3.5 rounded-2xl border text-left transition-all cursor-pointer flex flex-col justify-between min-h-[72px] ${
                      isSelected
                        ? 'border-[#C4121A] bg-red-50/60 dark:bg-red-950/20 ring-1 ring-[#C4121A]'
                    ...
                    <div className="flex items-center justify-between gap-1">
                      <span
                        className={`text-xs font-bold truncate ${
                          isSelected ? 'text-[#C4121A]' : 'text-zinc-900 dark:text-white'
                        }`}
                      >
                        {m.label}
                      </span>
                      {isSelected && <Check className="w-3.5 h-3.5 text-[#C4121A] shrink-0" />}
                    </div>
                ...
                <div className="flex items-center justify-between gap-3">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-xl text-xs font-bold transition-colors cursor-pointer shrink-0 ${
                      settings.autoPlay
                        ? 'bg-[#C4121A] text-white hover:bg-[#A30F16]'
                    ...
                    return (
                      <button
                        ...
                        className={`px-3 py-2.5 rounded-xl border text-left transition-all cursor-pointer flex items-center justify-between gap-2 ${
                          isSelected
                            ? 'border-[#C4121A] bg-red-50/70 dark:bg-red-950/20 text-[#C4121A] font-bold'
          ...
          {settings.mode === 'custom' && (
            <div className="space-y-3">
              ...
              >
                <Plus className="w-5 h-5 text-[#C4121A]" />
                <span className="text-xs font-bold text-zinc-900 dark:text-white">
        ...
        <div className="px-5 py-3.5 border-t border-zinc-100 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900/60 flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="px-5 py-2.5 rounded-xl bg-[#C4121A] text-white text-xs font-bold uppercase tracking-wider hover:bg-[#A30F16] transition-colors cursor-pointer shadow-sm"
          >
            Apply & Close
          </button>
        </div>
