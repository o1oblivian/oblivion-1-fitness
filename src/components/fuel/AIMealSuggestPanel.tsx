  ...
  if (!expanded) {
    return (
      <button
        ...
        disabled={loading}
        className="w-full flex items-center justify-between py-2.5 px-3.5 rounded-xl bg-white dark:bg-[#13161A] border border-[#EAE8E3] dark:border-white/10 hover:border-[#C4121A]/40 dark:hover:border-[#C4121A]/40 shadow-2xs transition-all cursor-pointer active:scale-[0.98] disabled:opacity-50"
      >
        <div className="flex items-center gap-2">
          {loading ? (
            <RefreshCw className="w-4 h-4 text-[#C4121A] animate-spin" />
          ) : (
        ...
        <span className="text-[10.5px] font-mono font-bold text-[#C4121A]">
    ...
    <div className="rounded-xl border border-[#EAE8E3] dark:border-white/10 bg-white dark:bg-[#13161A] shadow-2xs overflow-hidden">
      ...
      <div className="px-3 py-1.5 border-b border-[#EAE8E3] dark:border-white/10 flex items-center gap-3 bg-zinc-50/50 dark:bg-white/[0.01]">
        <div className="text-[10px] font-mono text-zinc-600 dark:text-stone-400 flex items-center gap-2">
          ...
          <span className="text-[#C4121A] font-bold">{Math.max(0,remainingProtein)}g P</span>
      ...
      {loading && (
        <div className="p-5 flex items-center justify-center gap-2">
          <div className="w-4 h-4 rounded-full border-2 border-[#C4121A] border-t-transparent animate-spin" />
      ...
      {error && !loading && suggestions.length === 0 && (
        <div className="p-4 text-center">
          <p className="text-[11px] text-[#C4121A] font-medium">{error}</p>
        </div>
      )}
          ...
          {suggestions.map((meal, i) => (
            <div key={i} className="px-3 py-2.5 space-y-1.5 hover:bg-zinc-50/50 dark:hover:bg-white/[0.02] transition-colors">
              ...
              <div className="flex items-center gap-3 pt-0.5 text-[10.5px] font-mono">
                ...
                <span className="text-[#C4121A] font-bold">{meal.macros.protein}g P</span>
