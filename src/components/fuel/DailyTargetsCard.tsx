    ...
    <div className="bg-white dark:bg-[#13161A] rounded-2xl p-4 sm:p-5 shadow-2xs border border-zinc-200/80 dark:border-white/10 relative overflow-hidden text-zinc-900 dark:text-white">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-sm font-bold text-zinc-900 dark:text-white flex items-center gap-2">
          <Target className="w-4 h-4 text-[#C4121A] dark:text-[#C4121A]" />
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="text-xs font-bold text-white bg-[#C4121A] hover:bg-[#b01017] px-3.5 py-1.5 rounded-xl active:scale-95 transition-all shadow-xs cursor-pointer"
          >
            Save
          </button>
        </div>
      ...
      <div className="grid grid-cols-5 gap-2 sm:gap-3 mb-4">
        <div className="col-span-2">
          ...
          <input
            ...
            className="w-full bg-zinc-50 dark:bg-white/[0.04] border border-zinc-200/80 dark:border-white/10 rounded-xl px-3 py-2 outline-none font-mono font-black text-base text-zinc-900 dark:text-white transition-all focus:border-[#C4121A] dark:focus:border-[#C4121A]"
          />
        </div>
        <div className="col-span-1 flex flex-col">
          <label className="text-[10px] font-mono font-bold text-[#C4121A] dark:text-red-400 uppercase tracking-wider mb-1 block text-center">
            Pro(g)
          </label>
          <input
            type="number"
            ...
            className="w-full bg-zinc-50 dark:bg-white/[0.04] border border-zinc-200/80 dark:border-white/10 rounded-xl px-1 py-2 outline-none font-mono font-bold text-center text-xs text-zinc-900 dark:text-white transition-all focus:border-[#C4121A] dark:focus:border-[#C4121A]"
          />
        </div>
        <div className="col-span-1 flex flex-col">
      ...
      <div className="flex justify-between items-center pt-3 border-t border-zinc-100 dark:border-white/10">
        ...
        <div className="flex items-center gap-1.5">
          <input
            ...
            className="w-24 bg-zinc-50 dark:bg-white/[0.04] border border-zinc-200/80 dark:border-white/10 text-right rounded-xl px-2.5 py-1 font-mono font-bold text-zinc-900 dark:text-white outline-none text-xs focus:border-[#C4121A] dark:focus:border-[#C4121A]"
          />
