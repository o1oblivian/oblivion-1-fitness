    ...
    <div className="bg-[#FDFCFB] dark:bg-[#181B20] rounded-3xl p-4 sm:p-5 shadow-2xs border border-[rgba(0,0,0,0.08)] dark:border-white/10 relative text-[#1A1E1D] dark:text-[#F7F5F0] flex flex-col justify-between">
      <div>
        <div className="flex justify-between items-center mb-3">
          ...
          <span className="text-[9px] font-mono font-bold bg-[#7A9382]/15 text-[#7A9382] px-2.5 py-0.5 rounded-full border border-[#7A9382]/30 uppercase">
            {balanceLabel}
          </span>
        </div>
        ...
        <div className="grid grid-cols-4 gap-2 text-center items-center mb-3">
          ...
          <div className="flex flex-col items-center bg-white dark:bg-[#22262B] p-2.5 rounded-2xl border border-[rgba(0,0,0,0.08)] dark:border-white/10 shadow-2xs">
            <div className="text-lg sm:text-xl font-black font-mono text-[#DC2626]">
              {trainingBurn}
            </div>
            <div className="text-[8.5px] font-mono font-bold text-[#DC2626] uppercase tracking-tight mt-0.5">
              Burn
            </div>
          </div>

          <div className="flex flex-col items-center bg-[#7A9382]/10 p-2.5 rounded-2xl border border-[#7A9382]/30 shadow-2xs">
            <div className="text-lg sm:text-xl font-black font-mono text-[#7A9382]">
              {remainingCals}
            </div>
            <div className="text-[8.5px] font-mono font-bold text-[#7A9382] uppercase tracking-tight mt-0.5">
              Remain
            </div>
          </div>
        </div>
