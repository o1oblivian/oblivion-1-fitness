      ...
      <div className="bg-white text-[#000000] w-full h-full min-h-screen p-3.5 shadow-2xl space-y-3 border border-[rgba(0,0,0,0.08)] relative animate-slideDownFade my-0">
        ...
        <div className="flex items-center justify-between border-b border-[rgba(0,0,0,0.08)] pb-3">
          <div className="flex items-center gap-2">
            <div className="w-10 h-10 rounded-2xl bg-[#C4121A] text-white flex items-center justify-center shadow-none">
              {content.icon}
            </div>
            <div>
              <span className="text-[10px] font-mono font-bold text-[#C4121A] dark:text-[#D91F28] uppercase tracking-widest block">
                {content.badge}
              </span>
        ...
        <div className="space-y-2 pt-1">
          <button
            ...
            className="w-full py-3.5 bg-[#C4121A] hover:bg-[#D91F28] text-white font-mono font-bold text-xs rounded-xl shadow-none transition-all active:scale-95 cursor-pointer flex items-center justify-center gap-2 uppercase tracking-wider"
          >
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 bg-[#F2F2F7] dark:bg-white/5 border border-[rgba(0,0,0,0.08)] dark:border-white/10 rounded-xl px-3 py-2 text-xs font-mono text-[#000000] dark:text-white placeholder-[#B8B0A2] dark:placeholder-gray-500 focus:outline-none focus:border-[#C4121A]"
            />
            <button
