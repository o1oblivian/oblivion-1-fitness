      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-[400] bg-black/60 dark:bg-black/80 backdrop-blur-sm flex items-end sm:items-center justify-center p-0 sm:p-4 animate-in fade-in duration-150" onClick={() => setShowDeleteConfirm(false)}>
          ...
          >
            ...
            {deleteError && (
              <p className="text-xs text-red-600 dark:text-red-400 mt-2 font-medium">{deleteError}</p>
            )}
            <div className="flex gap-2 mt-4">
              ...
              <button
                ...
                disabled={isDeleting}
                className="flex-1 py-2 rounded-lg bg-red-600 text-white text-xs font-semibold hover:bg-red-700 cursor-pointer disabled:opacity-50 flex items-center justify-center gap-1.5 transition-colors shadow-xs"
              >
