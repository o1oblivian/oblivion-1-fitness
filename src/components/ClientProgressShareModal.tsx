        ...
        <div className="space-y-3 bg-gray-100 dark:bg-white/5 p-4 rounded-2xl border border-black/5 dark:border-white/10 font-mono">
          ...
          <div className="space-y-2 text-xs">
            ...
            <label className="flex items-center justify-between p-2 rounded-xl bg-white dark:bg-[#14171F] border border-gray-200 dark:border-white/10 cursor-pointer hover:border-gray-400 dark:hover:border-white/20 transition-all">
              ...
              <input
                ...
                className="w-4 h-4 accent-[#3FB98E] rounded cursor-pointer"
              />
            </label>
          ...
          <div className="pt-1">
            ...
            <input
              ...
              className="w-full bg-white dark:bg-[#14171F] border border-gray-200 dark:border-white/10 rounded-xl px-2 py-1.5 text-xs text-gray-900 dark:text-white outline-none focus:border-[#3FB98E]"
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 min-w-0 bg-white dark:bg-[#14171F] border border-gray-200 dark:border-white/10 rounded-xl px-3 py-2 text-xs font-mono text-gray-900 dark:text-white outline-none focus:border-[#3FB98E] uppercase tracking-wider"
                    />
                    <button
        ...
        <div className="space-y-2">
          ...
          <div className="relative rounded-2xl p-4 border bg-gradient-to-b from-[#161B22] via-[#0D1117] to-[#161B22] border-white/10 shadow-2xl space-y-3 overflow-hidden">
            ...
            <div className="flex items-center justify-between font-mono text-[10px]">
              <span className="font-extrabold text-[#2D7FF9] tracking-wider uppercase">O1FC • COACH REPORT</span>
              <span className="text-gray-400 font-mono">#{athlete.key || 'ATH-01'}</span>
            </div>

            {/* Client Avatar & Name */}
            <div className="flex items-center gap-3 bg-white/5 p-2 rounded-xl border border-white/5">
              <div className="w-10 h-10 rounded-xl bg-[#3FB98E] text-white font-black text-sm flex items-center justify-center shrink-0">
                {athlete.avatar}
              </div>
              <div className="min-w-0 flex-1">
                <div className="flex items-center gap-2">
        ...
        <div className="grid grid-cols-2 gap-2 pt-1 font-mono">
          <button
            ...
            className={`py-2.5 px-3 rounded-xl font-bold text-xs flex items-center justify-center gap-2 transition-all ${
              isConsentVerified
                ? 'bg-[#3FB98E] hover:bg-[#2F9B73] text-white cursor-pointer active:scale-95 shadow-md'
