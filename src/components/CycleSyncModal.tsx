        ...
        {!cycleData && (
          <div className="p-3.5 space-y-3">
            <div className="text-center py-2">
              <div className="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3" style={{ background: 'rgba(45, 127, 249, 0.2)', border: '2px solid rgba(45, 127, 249, 0.4)' }}>
                <Droplet className="w-8 h-8 text-[#2D7FF9]" />
              </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-xl px-3 py-3 text-sm text-white outline-none focus:border-[#2D7FF9]/50 transition-colors [color-scheme:dark]"
                />
              </div>
              ...
              <button onClick={handleSave} className="w-full py-3.5 rounded-2xl bg-[#2D7FF9] hover:bg-[#1B65D4] text-white font-black text-sm active:scale-95 transition-all shadow-lg cursor-pointer">
