        ...
        <div className="p-3 sm:px-5 sm:py-3 border-b border-zinc-100 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900/30 flex flex-col sm:flex-row gap-2.5 items-stretch sm:items-center justify-between shrink-0">
          ...
          <div className="relative min-w-[200px] sm:w-64 shrink-0">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-1.5 rounded-xl bg-white dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700/60 text-xs text-zinc-900 dark:text-white placeholder-zinc-400 focus:outline-hidden focus:border-[#C4121A]"
            />
          </div>
        </div>
        ...
        <div className="p-3 sm:p-5 overflow-y-auto flex-1">
          {filteredWallpapers.length === 0 ? (
            <div className="py-16 text-center text-zinc-400 space-y-2">
              <ImageIcon className="w-8 h-8 mx-auto opacity-40 text-[#C4121A]" />
              ...
              {filteredWallpapers.map((wp) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Selected Badge */}
                    {isSelected && (
                      <div className="absolute top-2.5 left-2.5 w-6 h-6 rounded-full bg-[#C4121A] text-white flex items-center justify-center shadow-lg ring-2 ring-white/20">
