      ...
      <div className="bg-white dark:bg-[#121214] text-zinc-900 dark:text-white w-full max-w-lg rounded-[28px] border border-zinc-200/80 dark:border-white/[0.08] shadow-2xl overflow-hidden flex flex-col max-h-[92vh] animate-slideUpFade">
        ...
        <div className="px-5 py-4 border-b border-zinc-100 dark:border-white/[0.06] flex justify-between items-center bg-zinc-50/50 dark:bg-white/[0.02] shrink-0">
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-[10px] bg-red-500/10 dark:bg-red-500/20 text-[#C4121A] dark:text-[#C4121A] flex items-center justify-center font-bold">
        ...
        <div className="p-3.5 sm:p-4 space-y-3.5 overflow-y-auto flex-1 hide-scrollbar">
          ...
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-3 gap-2">
              <div className="bg-zinc-50 dark:bg-white/[0.03] border border-zinc-200/80 dark:border-white/[0.06] rounded-xl py-1.5 px-2.5 focus-within:border-[#C4121A] transition-colors">
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                className={`py-2 px-2 rounded-xl border text-center font-bold text-xs transition-all flex flex-col items-center justify-center gap-0.5 cursor-pointer ${
                  goalMode === 'fat_loss'
                    ? 'border-[#C4121A] bg-red-50 dark:bg-red-500/15 text-[#C4121A] shadow-xs'
              ...
              <div className="space-y-2 pt-0.5">
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="bg-zinc-50 dark:bg-white/[0.03] border border-zinc-200/80 dark:border-white/[0.06] rounded-xl py-1.5 px-2.5 flex flex-col justify-center">
                    ...
                    <span className={`text-sm font-mono font-extrabold ${weightDeltaKg < 0 ? 'text-[#C4121A]' : weightDeltaKg > 0 ? 'text-[#34C759]' : 'text-zinc-500 dark:text-zinc-400'}`}>
                ...
                {weeksToGoal > 0 && estimatedArrivalDate && (
                  <div className="bg-zinc-100 dark:bg-white/[0.04] border border-zinc-200/80 dark:border-white/[0.06] rounded-xl py-2 px-3 flex items-center justify-between text-xs">
                    <div className="flex items-center gap-1.5 text-zinc-700 dark:text-zinc-300 font-medium text-[11px]">
                      <Calendar className="w-3.5 h-3.5 text-[#C4121A] dark:text-[#C4121A]" />
                ...
                return (
                  <button
                    ...
                    className={`py-2 px-2.5 rounded-xl border text-left transition-all cursor-pointer ${
                      isActive
                        ? 'border-[#C4121A] bg-red-500/10 dark:bg-red-500/15 shadow-xs'
                        : 'border-zinc-200 dark:border-white/[0.06] bg-zinc-50 dark:bg-white/[0.03] hover:bg-zinc-100 dark:hover:bg-white/[0.06]'
                    }`}
                  >
                    <div className="flex items-center justify-between">
                      <span className={`text-[11px] font-bold ${isActive ? 'text-[#C4121A] dark:text-[#C4121A]' : 'text-zinc-900 dark:text-white'}`}>
                        {m.label}
                      </span>
                      {isActive && <Check className="w-3.5 h-3.5 text-[#C4121A] dark:text-[#C4121A]" />}
                    </div>
          ...
          <div className="bg-[#121316] text-white rounded-3xl p-4 sm:p-5 border border-white/10 shadow-xl space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <div className="h-2 w-full rounded-full overflow-hidden flex bg-white/10">
                <div style={{ width: `${pPercent}%` }} className="bg-[#C4121A] h-full" title={`Protein ${pPercent}%`} />
                <div style={{ width: `${cPercent}%` }} className="bg-zinc-300 h-full" title={`Carbs ${cPercent}%`} />
                <div style={{ width: `${fPercent}%` }} className="bg-[#E8B04A] h-full" title={`Fat ${fPercent}%`} />
              </div>
            </div>
        ...
        <div className="p-4 sm:p-5 border-t border-zinc-100 dark:border-white/[0.06] bg-zinc-50/50 dark:bg-white/[0.02] shrink-0">
          <button
            ...
            className="w-full py-3.5 bg-[#C4121A] hover:bg-[#9B0E14] text-white font-bold rounded-2xl shadow-lg shadow-red-500/20 active:scale-[0.98] transition-all text-xs tracking-wider uppercase flex items-center justify-center gap-2 cursor-pointer"
          >
